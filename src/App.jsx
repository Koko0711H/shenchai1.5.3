...
const T = {
  ...
  en: {
    ...
    homeIntro2: "Backed by state-owned strength combined with market-oriented innovation, FLYDEER POWER has become a leading diesel generator set manufacturer in China.",
